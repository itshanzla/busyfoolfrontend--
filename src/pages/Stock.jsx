...
export default function Stock() {
  ...
  const totalStockValue = stockItems.reduce((total, item) => {
    ...
    const value =
      item.total_purchased_price !== undefined &&
      item.total_purchased_price !== null
        ...
        <main className="flex-1 p-4 sm:p-6 space-y-6">
          <div className="max-w-7xl mx-auto">
            ...
            <Dialog
              ...
              onOpenChange={(open) => !open && setShowPurchaseModal(false)}
            >
                    ...
                    <tbody className="divide-y divide-gray-100/50">
                      {isLoading ? (
                        ...
                        <tr>
                          <td
                            colSpan={9}
                            className="px-6 py-16 text-center align-middle min-h-[300px]"
                          >
                        ...
                        stockItems.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-5 text-right font-bold text-emerald-600 text-lg border-r border-gray-100/40">
                              {item.purchase_price_per_unit !== undefined &&
                              item.purchase_price_per_unit !== null ? (
                                `${Number(item.purchase_price_per_unit).toFixed(
                                  2
                                )}`
                              ) : (
                            ...
                            <td className="px-6 py-5 text-right font-bold text-blue-700 text-lg border-r border-gray-100/40">
                              {item.total_purchased_price !== undefined &&
                              item.total_purchased_price !== null ? (
                                `${Number(item.total_purchased_price).toFixed(
                                  2
                                )}`
                              ) : item.purchase_price_per_unit !== undefined &&
                                item.purchase_price_per_unit !== null &&
                ...
                <div className="space-y-6 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={
                        editingStock
                          ? stockItems.find((s) => s.id === editingStock)
                              ?.ingredient?.id || ""
