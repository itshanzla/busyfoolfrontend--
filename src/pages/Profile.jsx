					...
					<div className="max-w-2xl mx-auto">
							...
							<form onSubmit={handleSubmit} className="p-6 space-y-8">
								...
								<div className="flex flex-col items-center space-y-4">
									<div className="relative group">
										<div className={`relative ${imageUploading ? 'animate-pulse' : ''}`}>
											<img
										...
										<label htmlFor="profilePicture" className="absolute inset-0 cursor-pointer group">
									...
									<p className="text-sm text-gray-500 text-center">
										...
										<br />
										<span className="text-xs text-gray-400">Recommended: 400x400px, max 5MB</span>
									</p>
								</div>
						...
						<div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100 mt-6">
							<div className="flex items-start space-x-3">
								...
								<div>
									<h3 className="font-semibold text-gray-900 mb-1">Profile Tips</h3>
									<p className="text-sm text-gray-600">
										Keep your profile information up to date to help others connect with you. 
										A complete profile helps build trust and makes networking more effective.
									</p>
								</div>
							</div>
						</div>
